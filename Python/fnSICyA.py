import pyodbc, base64, json, csv, time, hashlib, xlwt
...
def saveErrors(strError, pathLogs = None):
    dataError = []
...
def generateMD5(strText):
    hashMD5 =  hashlib.md5(pTexto.encode('utf-8')).hexdigest()
...
def convertFactorPercentFactor(value, typeConversion):
    valueReturn = value
...
def createJsonFile(fileName, dataJSON):
    pass


def updateJsonFile(fileName, dataJSON):
    isSuccessful = False
